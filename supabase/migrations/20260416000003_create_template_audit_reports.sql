...
DROP POLICY IF EXISTS "Service role has full access to template audit reports" ON template_audit_reports;
...
DROP POLICY IF EXISTS "Admins can view all template audit reports" ON template_audit_reports;
